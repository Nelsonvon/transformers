...
from transformers import YagoRefBertModel, YagoRefBertConfig, YagoRefBertForTokenClassification, YagoRefBertForPreTraining
...
def main():
    ...
    """
    reloaded the pretrained bert model and add a linear layer on top of it.
    """
    # results = {}
